...
//        item3.setText("list2");
//        item3.setIcon(resources.getIcon("icon/jinhuo_tuihuo"));
...
//        item4.setText("list2");
//        item4.setIcon(resources.getIcon("icon/jinhuo_tuihuo"));
...
//        item5.setText("list2");
//        item5.setIcon(resources.getIcon("icon/jinhuo_tuihuo"));
