...
import cn.ximuli.jframex.ui.component.panels.ExtrasPanel;
...
@Meta(value = "app.menu.view.components.extras", icon = "icons/extras_component", order = 4, id = "app.menu.view.components.extras")
@Slf4j
public class ExtrasInternalJFrame extends CommonInternalJFrame {
    private JPanel jPanel;

    public ExtrasInternalJFrame(ResourceLoaderManager resources, DesktopPanel desktopPane) {
