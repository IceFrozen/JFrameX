...
public class TabsComponentsPanel extends JPanel {
    ...
    public TabsComponentsPanel(ResourceLoaderManager resources) {
    ...
    private void customComponentsChanged() {
        ...
        if (leadingComponentButton.isSelected()) {
            ...
            leading.add(new JButton(resources.getIcon("icons/project")));
        }
        if (trailingComponentButton.isSelected()) {
            ...
            trailing.add(new JButton(resources.getIcon("icons/buildLoadChanges")));
            trailing.add(Box.createHorizontalGlue());
            trailing.add(new JButton(resources.getIcon("icons/commit")));
            trailing.add(new JButton(resources.getIcon("icons/diff")));
            trailing.add(new JButton(resources.getIcon("icons/listFiles")));
        }
    ...
    private void initTabIconPlacement(JTabbedPane tabbedPane, int iconPlacement) {
        ...
        tabbedPane.addTab("Search", resources.getIcon("icons/search.svg", iconSize, iconSize), null);
        tabbedPane.addTab("Recents", resources.getIcon("icons/RecentlyUsed.svg", iconSize, iconSize), null);
        if (topOrBottom) {
            tabbedPane.addTab("Favorites", resources.getIcon("icons/favorite.svg", iconSize, iconSize), null);
        }
    ...
    private void updateTabbedPanesRecur(Container container, Consumer<JTabbedPane> action) {
        for (java.awt.Component c : container.getComponents()) {
            ...
            if (c instanceof Container e) {
                updateTabbedPanesRecur(e, action);
            }
        }
    }
