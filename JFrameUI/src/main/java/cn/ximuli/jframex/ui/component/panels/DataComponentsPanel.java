...
public class DataComponentsPanel extends JPanel {
    ...
    public DataComponentsPanel(ResourceLoaderManager resourceLoader) {
        initComponents();
    ...
    private void dndChanged() {
        ...
        for (JComponent c : components) {
            if (dnd) {
                ...
                c.setTransferHandler(new DataComponentsPanel.DummyTransferHandler());
            } else
    ...
    private void alternatingRowsChanged() {
        ...
        if (alternatingRowsCheckBox.isSelected()) {
            alternateRowColor = table -> {
                ...
                return ThemeUIManager.isDarkMode()
                        ? ColorFunctions.lighten(background, 0.05f)
                        : ColorFunctions.darken(background, 0.05f);
            };
        }
    ...
    private void initComponents() {
        ...
        tree1.setModel(generateTreeNode());
    ...
    private static class DummyTransferHandler
        ...
        public boolean importData(TransferSupport support) {
            ...
            SwingUtilities.invokeLater(() -> JOptionPane.showMessageDialog(null, message, "Drop", JOptionPane.PLAIN_MESSAGE));
            return false;
        }
    }


    private DefaultTreeModel generateTreeNode() {
        ...
        pizza.add(new DefaultMutableTreeNode("pizza aglio e olio"));
        pizza.add(new DefaultMutableTreeNode("pizza margherita bianca"));
        food.add(pizza);
