...
import cn.ximuli.jframex.ui.demo.HintManager;
...
@Component
@Slf4j
public class BasicInternalFrame extends JCommonInternalFrame {

    private JPanel jPanel;

    public BasicInternalFrame(ResourceLoaderManager resources, JDesktopPane desktopPane) {
...
class BasicComponentsPanel extends JPanel {
    ...
    BasicComponentsPanel(ResourceLoaderManager resources) {
        initComponents();
        ...
        // match case button
        JToggleButton matchCaseButton = new JToggleButton(resources.getIcon("icons/matchCase"));
        matchCaseButton.setRolloverIcon(resources.getIcon("icons/matchCaseHovered"));
        matchCaseButton.setSelectedIcon(resources.getIcon("icons/matchCaseSelected"));
        matchCaseButton.setToolTipText("Match Case");

        // whole words button
        JToggleButton wordsButton = new JToggleButton(resources.getIcon("icons/words"));
        wordsButton.setRolloverIcon(resources.getIcon("icons/wordsHovered"));
        wordsButton.setSelectedIcon(resources.getIcon("icons/wordsSelected"));
        wordsButton.setToolTipText("Whole Words");

        // regex button
        JToggleButton regexButton = new JToggleButton(resources.getIcon("icons/regex"));
        regexButton.setRolloverIcon(resources.getIcon("icons/regexHovered"));
        regexButton.setSelectedIcon(resources.getIcon("icons/regexSelected"));
